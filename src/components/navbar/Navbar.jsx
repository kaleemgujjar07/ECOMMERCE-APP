...
//                   <div className="flex ">
//                     <h1 className=' text-2xl font-bold text-black  px-2 py-1 rounded' style={{ color: mode === 'dark' ? 'white' : '', }}>ECOMMERCE-APP</h1>
//                   </div>
//                 </Link>
//               </div>
            ...
            >
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl" style={{ backgroundColor: mode === 'dark' ? 'rgb(40, 44, 52)' : '', color: mode === 'dark' ? 'white' : '', }}>
                ...
                <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                  ...
                  {user?.user?.email === "gujjarkaleem37@gmail.com" ? <div className="flow-root">
                    <Link to={'/dashboard'} className="-m-2 block p-2 font-medium text-gray-900" style={{ color: mode === 'dark' ? 'white' : '', }}>
                      Admin
                    </Link>
                  </div> : ""}
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                 ...
                 {user ?  <Link to={'/order'} className="text-sm font-medium text-gray-700 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                  ...
                  {user?.user?.email === 'gujjarkaleem37@gmail.com' ? 
                   <Link to={'/dashboard'} className="text-sm font-medium text-gray-700 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                    Admin
                  </Link> : ""}
                  
                
                 {user ?  <a onClick={logout} className="text-sm font-medium text-gray-700 " style={{ color: mode === 'dark' ? 'white' : '', }}>Logout</a>  : ""}   

                  <Link to="/cart" className="p-2" style={{ color: mode === 'dark' ? 'white' : '', }}>
                    <img src="cart.svg" alt="cart" />
                    {cartItems.length ? <div className="absolute top-0 right-0 h-6 w-6 bg-red-500 text-white rounded-full flex justify-center items-center text-xs">{cartItems.length}</div> : null}
                  </Link>

                  <div onClick={toggleMode} className="bg-transparent text-xl cursor-pointer">
                    {mode === 'dark' ? <FiSun className='text-yellow-400' /> : <BsFillCloudSunFill />}
                  </div>
                </div>
              </div>
            </div>
